...
const ForgotPassword = () => {
  ...
  return (
    <div className="forgotbg flex justify-center items-center min-h-screen ">
      <div className="bg-transparent backdrop-blur-sm border shadow-xl bg-blue-600 border-white p-8 rounded-lg w-full max-w-md">
        <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-gray-600 mb-4">
                      We're improving our e-commerce platform with new features
                      and enhanced tracking capabilities. The system will remain
                      operational during the update.
                    </p>
                  </div>
                </div>
