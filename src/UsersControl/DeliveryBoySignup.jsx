...
function DeliveryBoySignup() {
  ...
  return <div className='signupbg p-10'>
    ...
    <div className='bg-gray-500 bg-clip-padding backdrop-filter  backdrop-blur bg-opacity-10 backdrop-saturate-100 backdrop-contrast-100 max-w-md mx-auto mt-8 p-6 rounded-lg shadow-2xl border border-spacing-5 border-lime-500'>
